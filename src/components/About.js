        ...
        <div className="flex justify-between relative pb-[60px]">            
            <div className="border-l-[40px] lg:border-l-[70px] xl:border-l-[110px] border-[#CCC193] relative text-[#154E59] p-8 md:p-14  flex flex-col gap-6 lg:gap-10 md:w-4/6 xl:w-5/6 md:h-4/5">
                ...
                <div className="lg:w-5/6 mx-auto">
                    ...
                    <p className="font-rakkas tracking-wide md:tracking-normal">ThriveSphere’s mission is to empower individuals to navigate life with clarity, confidence, and purpose. Through expert coaching, we help clients overcome limitations, develop a growth mindset, and achieve meaningful transformation in their personal and professional lives. Our commitment is to guide individuals toward self-discovery, emotional resilience, and long-term success.
                    </p>
                </div>

                <div className="lg:w-5/6 mx-auto">
                    <h1 className="font-cinzel">VISION</h1>
                    <p className="font-rakkas tracking-wide md:tracking-normal">ThriveSphere envisions a world where everyone has the tools and support to unlock their full potential. We aim to be a trusted partner in personal and professional development, fostering a community of confident and purpose-driven individuals. Through personalized coaching, we strive to replace confusion with clarity, doubt with confidence, and make success accessible to all.</p>
                </div>

                <div className="lg:w-5/6 mx-auto">
                    <h1 className="font-cinzel">WHY CHOOSE US</h1>
                    <p className="font-rakkas tracking-wide md:tracking-normal">ThriveSphere offers more than traditional coaching. Our certified experts use proven strategies to deliver real results. We personalize our approach to meet individual goals, ensuring tailored guidance. Our focus is on long-term transformation, equipping clients with the mindset, tools, and strategies for lasting change. With a results-driven approach, we help individuals gain clarity, confidence, and actionable steps toward success.</p>
            ...
            <div className="hidden md:block  ">
                <Image src="/about1.svg" alt="lady with a grain flower" width={100} height={100} className=" w-[150px] lg:w-[230px] ml-[60px] lg:mr-[60px] mt-2 xl:w-[250px] xl:-ml-[20px] 2xl:w-[320px] " />
                ...
                <Image src="/about2.svg" alt="lady with a grain flower" width={100} height={100} className="w-[140px] lg:w-[200px] mt-[90px] lg:mt-[65px] xl:w-[260px] 2xl:w-[280px]" />
