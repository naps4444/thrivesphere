...
<h1 className="gradient-border text-[18px]  lg:text-xl xl:text-2xl 2xl:text-3xl -mt-6 mb-6 text-center w-[160px] lg:w-[230px] lg:py-[2px] text-white mx-auto">HAPPY CLIENTS</h1>
        ...
        >
          <SwiperSlide>
            <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
              <p className="mx-auto w-10/12 font-cinzel">
              ...
              <h2 className="mt-2 text-[14px] font-bold font-volkhov">JANNY HILLS - Entrepreneur</h2>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
              ...
              <h2 className="mt-2 text-[14px] font-bold font-volkhov">MARK JOHNSON - Graphic Designer</h2>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
              ...
              <h2 className="mt-2 text-[14px] font-bold font-volkhov">LISA ROBERTS - Software Engineer</h2>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
              ...
              <h2 className="mt-2 text-[14px] font-bold font-volkhov">ALEX SMITH - Project Manager</h2>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
              ...
              <h2 className="mt-2 text-[14px] font-bold font-volkhov">SOPHIA CARTER - Digital Marketer</h2>
            </div>
          </SwiperSlide>
      ...
      <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
        ...
        <h2 className="mt-2 text-[14px] font-bold font-volkhov">SOPHIA CARTER - Marketing Strategist</h2>
      </div>
    </SwiperSlide>
    ...
    <SwiperSlide>
      <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
        ...
        <h2 className="mt-2 text-[14px] font-bold font-volkhov">DANIEL OWENS - Small Business Owner</h2>
      </div>
    </SwiperSlide>
    ...
    <SwiperSlide>
      <div className="relative w-10/12 bg-[#EEE6DE] text-center py-4 pt-8 rounded-t-lg mx-auto px-2">
        ...
        <h2 className="mt-2 text-[14px] font-bold font-volkhov">JASMINE LEE - HR Director</h2>
      </div>
    </SwiperSlide>
        </Swiper>
      </div>
      ...
      <div className="hidden md:flex gap-6 md:py-4 scroll-container px-10">
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <h2 className="mt-2 text-[18px] font-bold font-volkhov">DAVID CARTER - HR Consultant</h2>
        </div>
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <h2 className="mt-2 text-[18px] font-bold font-volkhov">NATASHA REED - Small Business Owner</h2>
        </div>
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <h2 className="mt-2 text-[18px] font-bold font-volkhov">JASON RIVERA - Financial Analyst</h2>
        </div>
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <h2 className="mt-2 text-[18px] font-bold font-volkhov">EMILY WATSON - School Teacher</h2>
        </div>
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <p className="mx-auto w-10/12 font-cinzel">Before coaching with Nduka, I felt stuck in my career. He helped me redefine my goals and develop the confidence to step up in my leadership role.</p>
    <h2 className="mt-2 text-[18px] font-bold font-volkhov">SOPHIA CARTER - Marketing Strategist</h2>
        </div>
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <p className="mx-auto w-10/12 font-cinzel">I was overwhelmed managing my startup, but Nduka’s coaching provided me with structure and accountability. My business has grown significantly.</p>
    <h2 className="mt-2 text-[18px] font-bold font-volkhov">DANIEL OWENS - Small Business Owner</h2>
        </div>
        ...
        <div className="relative w-[40%] min-w-[40%] md:w-[30%] md:min-w-[30%] lg:w-[25%] lg:min-w-[25%] bg-[#EEE6DE] text-center py-4 pt-8 rounded-lg flex-shrink-0">
          ...
          <p className="mx-auto w-10/12 font-cinzel">I struggled with workplace stress and work-life balance. Nduka’s strategies helped me establish boundaries and lead with confidence.</p>
    <h2 className="mt-2 text-[18px] font-bold font-volkhov">JASMINE LEE - HR Director</h2>
        </div>
