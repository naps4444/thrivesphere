        ...
        <div>
          ...
          <div className="mt-5 py-8 md:py-10 lg:py-14 bg-[#154E59] text-white">
            <div className="flex flex-col-reverse md:grid md:grid-cols-2 justify-between w-full px-6">
              ...
              <Image src="/sev2.svg" alt="smiling woman on white" height={100} width={100} className="mx-auto w-full md:w-[400px] xl:w-[500px] 2xl:w-4/5 border-white border-[1px] p-[1px]" />
            </div>
          </div>

          <div className="grid md:grid-cols-2 justify-between mt-5 py-4 md:py-10 lg:py-14 px-6">
            <Image src="/sev3.svg" alt="smiling woman on white" height={100} width={100} className="mx-auto w-full md:w-[400px] xl:w-[500px] 2xl:w-4/5 border-black border-[1px] p-[1px]" />
